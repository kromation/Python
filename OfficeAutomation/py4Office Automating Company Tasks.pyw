...
############################
#open the workbook
# TODO AttributeError: 'Book' object has no attribute 'range'
wb = xw.Book(r"C:\Users\khull\OneDrive\Documents\Manish corner\Programming Practical\Python\Python demo.xlsx")
#faced issue resolving blank spaces in the python environmentS
